...
<<<<<<< HEAD
            ...
            <div class="container mb-3">
                <form action="MenuServlet" method="get" class="d-flex justify-content-center">
                    <input type="text" name="search" class="form-control w-50 me-2" placeholder="Tìm món ăn...">
            ...
            <ul class="menu-filters">
                <c:forEach items="${catelori}" var="o">
                    <li class="${tag == o.categoryID ? 'active' : ''}">
                        <a class="text-decoration-none ${tag == o.categoryID ? 'text-white' : 'text-dark'}"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card h-100 shadow-sm">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <!-- Yêu thích -->
                                    <form action="${pageContext.request.contextPath}/favoriteFoodServlet" method="post" class="mb-3">
                                        <input type="hidden" name="foodId" value="${o.foodID}" />

                                        <c:choose>
                                            <c:when test="${favoriteFoodIds != null && favoriteFoodIds.contains(o.foodID)}">
                                                <input type="hidden" name="purpose" value="unlike" />
                                                <button type="submit" class="favorite-btn">❤️</button>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="hidden" name="purpose" value="like" />
                            ...
                            <div class="card h-100 shadow-sm">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <form action="${pageContext.request.contextPath}/CartServlet"
                                          method="post" class="mt-auto d-flex align-items-center">
                                        <!-- Bắt buộc có hidden fields để CartServlet không bị null -->
                                        <input type="hidden" name="foodId"    value="${o.foodID}" />
                                        <input type="hidden" name="foodName"  value="${o.defaultFoodName}" />
                                        <input type="hidden" name="image"     value="${o.image}" />
                                        <input type="hidden" name="price"     value="${o.price}" />
